...
namespace schoolMVC.Controllers
{
    public class ProductModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,ProductName,SellerName,prize,image")] ProductModel productModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ID,ProductName,SellerName,prize,image")] ProductModel productModel)
        {
